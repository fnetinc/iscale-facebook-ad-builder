...
const BrandForm = ({ onClose, onSave, initialData = null }) => {
    const { customerProfiles } = useBrands();
    ...
    const handleAddProduct = () => {
        try {
            if (newProduct.name) {
                const validatedName = validateProductName(newProduct.name);
                const validatedDescription = validateProductDescription(newProduct.description);
