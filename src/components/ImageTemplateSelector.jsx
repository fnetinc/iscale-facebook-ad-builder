...
export default function ImageTemplateSelector({ onSelect, onClose, embedded = false }) {
    ...
    const fetchFilters = async () => {
        try {
            const response = await fetch('http://localhost:3001/api/image-templates/filters');
    ...
    const fetchTemplates = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:3001/api/winning-ads?${params}`);
            const data = await response.json();
    ...
    const handleTemplateSelect = async (template) => {
        ...
        try {
            const response = await fetch(`http://localhost:3001/api/image-templates/${template.id}/preview`);
    ...
    const handleDelete = async () => {
        try {
            const response = await fetch('http://localhost:3001/api/winning-ads/bulk-delete', {
                method: 'POST',
                headers: {
