                            ...
                            <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                {filteredAccounts.map(account => (
                                    <div
                                        ...
                                        className={`px-4 py-3 cursor-pointer hover:bg-blue-50 border-b border-gray-100 last:border-b-0 ${selectedAdAccount?.id === account.id ? 'bg-blue-50' : ''
                                            }`}
                                    >
            ...
            {selectedAdAccount && !showDropdown && (
                <div className="mt-6 bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4">
                        <h3 className="text-lg font-bold text-white">{selectedAdAccount.name}</h3>
                        <div className="flex items-center gap-4 mt-2 text-blue-100 text-sm">
                            <span>ID: {selectedAdAccount.accountId}</span>
                            <span>•</span>
                            <span className={`px-2 py-0.5 rounded text-xs font-medium ${selectedAdAccount.status === 1 ? 'bg-green-500 text-white' : 'bg-red-500 text-white'
                                }`}>
