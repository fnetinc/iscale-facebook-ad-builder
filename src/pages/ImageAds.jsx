...
import { ChevronRight, ChevronLeft, Check, Briefcase, Package, Users, Image, Hash, FileText, Sparkles, Download, ChevronDown, ChevronUp, Settings } from 'lucide-react';
...
export default function ImageAds() {
    ...
    const [wizardData, setWizardData] = useState({
        ...
        resolution: '1K', // Fal.ai Nano Banana Pro: 1K, 2K, or 4K
        campaignDetails: {
            offer: '',
            urgency: '',
            messaging: ''
    ...
    const handleImageGeneration = async (copy) => {
        ...
        try {
            ...
            try {
                ...
                const saveResponse = await fetch('http://localhost:3001/api/generated-ads/batch', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
        ...
        <div className="max-w-5xl mx-auto">
                    ...
                    {steps.map((step, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className={`text-xs font-medium transition-colors ${isActive ? 'text-purple-600' :
            ...
            <div className="mt-6 flex items-center justify-between">
                ...
                <div className="flex gap-3">
                    {/* Navigation Buttons (only for steps 1-8) */}
                    {currentStep <= 8 && (
                        <>
                            <button
                                onClick={prevStep}
                            ...
                            {currentStep === 8 ? (
                                <button
                                    ...
                                    className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 font-medium shadow-lg shadow-purple-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:scale-105"
                                >
                                ...
                                <button
                                    onClick={nextStep}
                                    disabled={!canProceed()}
                                    className="flex items-center gap-2 px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                >
                                    Continue
...
function ImageSizeStep({ selectedSizes = [], onSelect, resolution, onResolutionChange, model, onModelChange }) {
    ...
    return (
        <div>
            ...
            <p className="text-sm text-purple-600 font-medium mb-6">{selectedSizes.length} of 3 selected</p>
                    ...
                    return (
                        <div
                            ...
                            className={`p-6 rounded-xl border-2 transition-all relative ${isRequired
                                ? 'border-purple-600 bg-purple-50 shadow-lg cursor-default'
                                : isSelected
                        ...
                        >
                            ...
                            {isRequired ? (
                                <div className="absolute top-3 right-3 px-2 py-1 bg-purple-600 text-white text-xs font-bold rounded">
                                    REQUIRED
                                </div>
                            ) : (
                                <div className={`absolute top-3 right-3 w-6 h-6 rounded border-2 flex items-center justify-center transition-colors ${isSelected ? 'bg-purple-600 border-purple-600' : 'bg-white border-gray-400'
                                    }`}>
            ...
            <div className="max-w-4xl mx-auto mb-8">
                <button
                    ...
                    className="flex items-center gap-2 text-gray-600 font-medium hover:text-purple-600 transition-colors mb-4"
                >
                    <Settings size={18} />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                >
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        {model === 'nano-banana-pro' && <Check className="text-purple-600" size={20} />}
                                    </div>
                                ...
                                >
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        {model === 'imagen4' && <Check className="text-purple-600" size={20} />}
                                    </div>
  ...
  "variations": [
    ...
    return (
        <div>
                ...
                {showPrompt && (
                    <div className="px-4 pb-4 border-t border-gray-100">
                        ...
                        <textarea
                            ...
                            className="w-full h-64 p-3 text-xs font-mono border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent resize-none"
            ...
            <div className="mt-6 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-4 max-w-3xl">
...
function ReviewItem({ label, value, icon: Icon }) {
    return (
        <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
            <Icon className="text-purple-600 flex-shrink-0" size={18} />
...
function CopySelectionStep({ generatedCopy, wizardData, onBack, onRegenerate, isRegenerating, onProceed }) {
    ...
    const handleRegenerateField = async (field) => {
        ...
        try {
            const response = await fetch('http://localhost:3001/api/regenerate-field', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    field,
    ...
    const RegenerateButton = ({ field }) => (
        <button
            ...
            className="ml-2 p-1 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-full transition-colors"
            title="Regenerate this field"
        >
            <Sparkles size={14} className={regeneratingField === field ? 'animate-spin text-purple-600' : ''} />
        </button>
    );
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl p-6">
                        <div className="text-xs font-medium text-purple-600 mb-3">PREVIEW</div>
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                            ...
                            <button className="w-full bg-purple-600 text-white font-medium py-2 px-4 rounded-lg">
                                {currentCopy.cta}
                            </button>
                        </div>
                        <div className="mt-4 text-xs text-gray-600 space-y-1">
                            ...
                            <div><strong>Template:</strong> {generatedCopy.metadata.template}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-6 flex items-center justify-between">
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        <Sparkles size={20} className={isRegenerating ? 'animate-spin' : ''} />
                        {isRegenerating ? 'Recreating...' : 'Recreate All'}
                    </button>
                </div>
                <button
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto mb-8">
                {displayImages.map((img, index) => (
                    <button
                        ...
                        className="group relative aspect-square rounded-xl overflow-hidden border-2 border-gray-200 hover:border-purple-600 transition-all hover:shadow-xl hover:scale-105"
                    >
                        <img
            ...
            <div className="flex gap-4 justify-center">
                ...
                <button
                    onClick={onRestart}
                    className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 font-medium shadow-lg transition-all"
                >
                    Create New Ad
                </button>
            </div>
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-100 rounded-xl overflow-hidden aspect-square flex items-center justify-center">
                                        {imgError ? (
                                            ...
                                            <img
                                                src={viewedImage.url.startsWith('http') ? viewedImage.url : `http://localhost:3001${viewedImage.url}`}
                                                alt="Selected Ad"
                                ...
                                <div className="space-y-6">
                                    ...
                                    {/* Download Button */}
                                    <a
                                        href={viewedImage.url.startsWith('http') ? viewedImage.url : `http://localhost:3001${viewedImage.url}`}
